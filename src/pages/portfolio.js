...
//   query {
//     beerHopper: file(relativePath: { eq: "beerHopper1.png" }) {
//         childImageSharp {
//             fluid {
...
//         </Image.Group>
//         </Item>
//         <Item className="project beerHopper" style={{"display": "flex"}}>
//         <Item.Image style={{"flex": "1 1 auto"}}>
//                 <Img
//                     fluid={data.beerHopper.childImageSharp.fluid}
//                 />
//             </Item.Image>
//         <Item.Content >
//           <Item.Header className="section-title" as={Grid} style={{"flex": "1 1 auto"}}>
//             BeerHopper
//               <a
